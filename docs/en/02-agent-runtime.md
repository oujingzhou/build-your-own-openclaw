...
export function buildSystemPrompt(config, providerConfig, skillsPrompt?) {
  ...
  // Append provider custom prompt
  if (providerConfig.systemPrompt) parts.push("", providerConfig.systemPrompt);

  // Append Skills list (XML format, generated by pi-coding-agent)
